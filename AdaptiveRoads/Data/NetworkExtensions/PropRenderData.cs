namespace AdaptiveRoads.Data.NetworkExtensions {
    ...
    public struct PropRenderData {
        ...
        public static void CalculatePropData(
            ...
            if (props != null) {
                ...
                NetNode.FlagsLong vanillaNodeFlags = laneTransition.NodeID.ToNode().flags;
                ...
                for (int i = 0; i < nProps; i++) {
                    ...
                    if (trackRenderData.Length >= prop.m_minLength) {
                        ...
                        //if (prop.Check(vanillaNodeFlags, nodeFlags, laneTransition.m_flags, trackRenderData.Curve))
                        {
                                    ...
                                    if (randomizer.Int32(100u) < prop.m_probability) {
                                        ...
                                        Vector3 position;
                                        {
                                            ...
                                            if (prop.m_position.x != 0f) {
                                                ...
                                                position.x += tan.z * prop.m_position.x;
                                                position.z -= tan.x * prop.m_position.x;
                                            }
        ...
        // concept only: merger of calculate props + RenderProps
        private static void RenderPropsSlow(
            RenderManager.CameraInfo cameraInfo,
            ref LaneTransition laneTransition,
            ref TrackRenderData trackRenderData,
            NetInfoExtionsion.Track trackInfo,
