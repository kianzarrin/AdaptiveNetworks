...
#region overlay
        ...
        public void EnqueuOverlay(NetInfoExtionsion.Track trackInfo, ref OutlineData outline, bool turnAround, bool DC) {
            if(Overlay.HoveredInfo == trackInfo) {
                OutlineQueue.Enqueue(new OverlayData { Outline = outline, turnAround = turnAround, DC = true });
            }
        }
